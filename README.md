...
这是一个基于 DeepSeek Harness 的 **AI 科普/知识讲解类短视频制作** 自动化工作流。
...
### 2. 配置 API 密钥 (必填)
本 Skill 依赖多个外部 API。请访问我们的 **[统一配置文档](https://your-config-doc-url.com)** 获取详细的申请指引和配置方法。
...
/install-skill https://github.com/YOUR_USERNAME/kepu-video-open-source
```
...
## 👨‍💻 作者
- **Jack**: [GitHub Profile](https://github.com/jack_)
